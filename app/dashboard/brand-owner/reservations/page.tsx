...
export default function ReservationsPage() {
  ...
  useEffect(() => {
    handleFilter()
  }, [searchQuery, selectedSpace, selectedStatus, selectedDate, bookings])

  const exportToCSV = () => {
    const csvContent = [
      ["Customer Name", "Email", "Phone", "Space", "Start Time", "End Time", "Status", "Payment Status", "Amount"],
      ...
      <main className="flex-1 ml-64 overflow-auto">
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Manage and track all your space bookings</p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {filteredBookings.map((booking) => (
                  <div key={booking.id} className="border rounded-lg p-6 hover:bg-muted/50 transition-colors">
                    <div className="flex items-center justify-between">
